...
'// Created: 7/27/2017
'// Description: Page to make deposit
'//====================================================================================================
Imports System.Data
    ...
    Protected Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        Try
            ...
            With SqlCmd.Parameters
                ...
                .AddWithValue("@CHECK_NO", Trim(txtCheckNum.Value)).Direction = ParameterDirection.Input
            ...
            successalert.InnerHtml =
                "<html><body><h3>Deposit Transaction Completed Successfully</h3>" &
                   " <b>Status</b>: Deposit Completed <br />" &
                   " <b>Confirmation #</b>: " & strconf & "<br />" &
                   " <b>Deposit Account</b>: " & ddlAccounts.Text & "<br />" &
                   " <b>Deposit Amount</b>: " & txtAmount.Value & "<br />" &
                   " <b>Description</b>: " & txtDesc.Text & "<br />" &
                   " <br />" &
                   "<a href='Deposit.aspx'>Make a Deposit</a>" &
                   "</body></html>"
